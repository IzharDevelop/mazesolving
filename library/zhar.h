// ==================================================================== LIBRARY MAZE BY SMK TELKOM DU ==============================================================================

// DEVELOPER : IZHARDEVELOP
// EMAIL : FROMZHAR@GMAIL.COM
// GITHUB : GITHUB.COM/IZHARDEVELOP
// YOUTUBE : YOUTUBE.COM/IZHARDEVELOP
// WEBSITE : IZHARDEVELOP.MY.ID
...
void baca_hitam(int speedlow, int speedfast) { 
    while (1) { // Infinite loop for continuous operation
        // Read IR sensors
        int IR_1_B = ir_Modul(1,  75, NONE);;
        int IR_2_B = ir_Modul(2,  100, NONE);;
        int IR_3_B = ir_Modul(3,  100, NONE);;
        int IR_4_B = ir_Modul(4,  100, NONE);;
        int IR_5_B = ir_Modul(5,  75, NONE);;
        ...
        if ((IR_1_B == TRUE && IR_2_B == TRUE) ||
            ...
            if (IR_3_B == TRUE) {
                ...
                moveMotors(FORWARD_DIRECTION, FORWARD_DIRECTION, speedfast, 0); // Turn slightly right
            } else if (IR_4_B == TRUE) {
                moveMotors(FORWARD_DIRECTION, FORWARD_DIRECTION, 0, speedfast); // Turn slightly left
            } else if (IR_5_B == TRUE) {
...
void misi(int speedlow, int speedfast) { 
    ...
    mundur(speedlow, 50); // Move forward with speed for 100 ms
}
// DEVELOPER : IZHARDEVELOP
// EMAIL : FROMZHAR@GMAIL.COM
// GITHUB : GITHUB.COM/IZHARDEVELOP
