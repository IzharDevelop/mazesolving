...
void main(void){ 
    ...
    baca_hitam(3,4);
    kanan(8,4,100);
    baca_hitam(3,4);//lurus dari pertigaan pertama
    stop(100);
    kanan(8,5,200);
    baca_hitam(3,4);//perempatan tengah
    maju(5,100);
    baca_hitam(3,5);
    stop(100);
    kanan(3,5,250); // kembali ke start
    baca_hitam(3,4); 
    stop(100);
    kanan(5,3,250); //kembali ke base
    baca_hitam(8,4);
    stop(1000);
    mundur(3,150);
    kiri(3,5,250);// reposisi ke start
    // end 1
    ...
    baca_hitam(3,4);
    kanan(8,3,200);//menuju mencet
    baca_hitam(3,4);
    kiri(3,5,250);//mencet
    baca_hitam(3,4);
    stop(100);
    mundur(3,150);
    kanan(5,3,250);//lanjut
    
    baca_hitam(3,4);
    misi(3,4);
    kiri(3,5,250);//mencet yg ke2
    baca_hitam(3,4);
    stop(100);
    mundur(3,150);
    kanan(5,3,250);//lanjut
